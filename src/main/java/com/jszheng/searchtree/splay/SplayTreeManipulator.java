...
public final class SplayTreeManipulator extends AbstractBstManipulator<SplayTree> {
    ...
    protected void comment() {
        ...
        System.out.println("c. 使用分攤 (amortized) 方式，使插入、尋找 與刪除時間達 O(log n)");
        System.out.println("d. 藉由將常尋訪的節點，旋轉至根節點附近，進而提高效能");
        System.out.println("e. 進行 Select 操作後，可隨時利用 print 觀察變化喔 :)");
        System.out.println();
    }
